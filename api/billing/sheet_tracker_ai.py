...
def ai_plan_rows(headers: list, recent_rows: list, facts: list,
    ...
    try:
        prompt = (
            ...
            + _render_facts(facts) + "\n\n"
            "TASK:\n"
            "1. EVERY billing period listed above is missing from the sheet and must be added — do not "
            "skip any, do not add any others. For EACH, oldest first, produce a COMPLETE new row "
            "matching this sheet's columns exactly, continuing its own patterns:\n"
