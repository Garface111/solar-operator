...
HINTS: dict[str, dict[str, str]] = {
    ...
    # Central Maine Power (Avangrid) — sso.cmpco.com / Liferay portal.cmpco.com.
    "cmp": {
        "user": ("input[type=\"email\"], input[name=\"username\" i], "
...
def hint_key_for(provider: str) -> str:
    """A known inverter/gmp/eversource/cmp key uses its own hint; any other code
    is a SmartHub co-op (vec/wec/sh_*) and shares the one SmartHub login form."""
    p = (provider or "").lower()
