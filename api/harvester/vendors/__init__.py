...
portal password (the Cloud Capture premise — "just give us your logins"):
  ...
  * UTILITIES — GMP, Eversource (CT/MA/NH), Central Maine Power, + the ~530
    SmartHub co-ops. No public API, cookie-bound; a real browser is the only way
    in (monthly bills, ~12h cadence).
