    ...
    *,
    ...
    user = {
        ...
        "leadership_priorities": [
            ...
            "Desk monologue is not work. mind_propose/introspection axioms are not work.",
            "Ship array-operator public/ changes into the sandbox; chamber redeploys automatically",
            "Grow coverage only when it unblocks owners — prefer one screen fix over 10 utility tickets",
        ...
        "constraints": {
            "max_actions": 3,
            "bias": "code_hire_chamber_first",
            "wait_is_last_resort": True,
            "empty_actions_forbidden": True,
            "prefer_action": "code_hire with sandbox=true repo=array-operator for user-visible public/ delta",
            ...
            "never": [
                ...
                "desk speak as substitute for a chamber ship",
            ],
        },
