"""Send Bruce the v1.9.2 EnergyAgent extension as a DOWNLOAD LINK (not an
...
SUBJECT = "EnergyAgent extension v1.9.2 — download link"
DL = "https://github.com/Garface111/solar-operator/releases/download/ext-v1.9.2/solar-operator-extension-v1.9.2.zip"

HTML = f"""\
<div style="font-family: Georgia, serif; font-size: 15px; color: #1a1a1a; line-height: 1.55; max-width: 560px;">
<p>Hi Dad,</p>

<p>Latest EnergyAgent extension — v1.9.2. Here's the download link:</p>
...
<p style="margin: 18px 0;">
  <a href="{DL}" style="background:#2e7d32;color:#fff;padding:11px 18px;
     ...
     font-size:15px;">Download EnergyAgent v1.9.2 (.zip)</a>
</p>
...
<ol>
  ...
  <li>Top-left: <b>Load unpacked</b> &rarr; pick the extracted
      <code>solar-operator-extension-v1.9.2</code> folder.</li>
</ol>

<p><b>Pin it:</b> puzzle-piece icon (&#129513;) top-right of Chrome &rarr;
find <b>EnergyAgent</b> &rarr; click the pin.</p>

<p>This version can now read your inverters individually from <b>three</b>
monitoring sites &mdash; SolarEdge, Fronius (Solar.web), and SMA (Sunny Portal).
On the array site, pick your brand, click "Log in with…", sign in the way you
always do, and each inverter shows up on its own. Green Mountain Power capture
keeps working exactly the same.</p>
...
Latest EnergyAgent extension — v1.9.2. Download link:
...
6. Top-left: Load unpacked -> pick the extracted
   solar-operator-extension-v1.9.2 folder.

PIN: puzzle-piece (top-right of Chrome) -> EnergyAgent -> pin.

This version reads your inverters individually from THREE monitoring sites —
SolarEdge, Fronius (Solar.web), and SMA (Sunny Portal). On the array site, pick
your brand, click "Log in with...", sign in the way you always do, and each
inverter shows up on its own. GMP capture keeps working the same.
